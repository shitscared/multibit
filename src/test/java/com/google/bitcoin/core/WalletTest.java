...
import com.google.fastcoin.core.CoreTestUtils.BlockPair;
...
import com.google.fastcoin.store.MemoryBlockStore;
...
import static com.google.fastcoin.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    private Transaction sendMoneyToWallet(Wallet wallet, Transaction tx, AbstractBlockChain.NewBlockType type) throws IOException,
        ...
        if (type == null) {
            ...
            BlockPair bp = com.google.fastcoin.core.CoreTestUtils.createFakeBlock(params, blockStore, tx);
    ...
    private Transaction sendMoneyToWallet(Wallet wallet, BigInteger value, Address toAddress, AbstractBlockChain.NewBlockType type)
        ...
        return sendMoneyToWallet(wallet, com.google.fastcoin.core.CoreTestUtils.createFakeTx(params, value, toAddress), type);
    }

    private Transaction sendMoneyToWallet(BigInteger value, AbstractBlockChain.NewBlockType type) throws IOException,
            VerificationException {
        return sendMoneyToWallet(this.wallet, com.google.fastcoin.core.CoreTestUtils.createFakeTx(params, value, myAddress), type);
    }
  ...
  @Test
   public void largeBalance() throws Exception {
    ...
    public void pending1() throws Exception {
        ...
        com.google.fastcoin.core.CoreTestUtils.BlockPair fakeBlock = CoreTestUtils.createFakeBlock(params, blockStore, t1Copy);
