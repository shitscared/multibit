...
public enum View {
    ...
    TRANSACTIONS_VIEW,
    SEND_FASTCOIN_VIEW,
    SEND_FASTCOIN_CONFIRM_VIEW, // obsolete - now done with Swing dialog
    RECEIVE_FASTCOIN_VIEW,
    HELP_CONTENTS_VIEW,
    HELP_ABOUT_VIEW,
    PREFERENCES_VIEW,
    ...
    public static View parseOldView(Integer viewNumber) {
        ...
        switch (viewNumber) {
            ...
            case 2  : return SEND_FASTCOIN_VIEW;
          //case 3  : return SEND_FASTCOIN_CONFIRM_VIEW; (obsolete)
            case 4  : return RECEIVE_FASTCOIN_VIEW;
    ...
    public static int toOldViewNumeric(View view) {
        ...
        switch (view) {
            ...
            case SEND_FASTCOIN_VIEW : return 2;
            case RECEIVE_FASTCOIN_VIEW : return 4;
