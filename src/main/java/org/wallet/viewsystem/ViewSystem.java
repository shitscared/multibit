...
import com.google.fastcoin.core.WalletEventListener;

/**
 * An interface describing a collection of views that are used to render the FastcoinWallet application.
 * @author jim
 *
 */
public interface ViewSystem extends WalletEventListener { 
    ...
    /**
     * A method called when FastcoinWallet online status changes between online, connecting. error.
     */
