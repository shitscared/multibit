...
public class ActivatedHyperlinkListener implements HyperlinkListener {
    ...
    private static final String FASTCOIN_WALLET_HOST_NAME = "www.wallet.org";
    private static final String FASTCOIN_WALLET_HOST_NAME2 = "test.wallet.org";
    private static final String FASTCOIN_WALLET_HOST_NAME3 = "188.138.113.201";
    private static final String FASTCOIN_WALLET_HOST_NAME4 = "localhost";
    ...
    public ActivatedHyperlinkListener(FastcoinWalletFrame frame, Browser browser) {
            ...
            Runnable runner = new Runnable() {
                ...
                public void run() {
                    if ((HTTP_PROTOCOL.equals(url.getProtocol()) || HTTPS_PROTOCOL.equals(url.getProtocol())) && 
                            (FASTCOIN_WALLET_HOST_NAME.equals(url.getHost()) || FASTCOIN_WALLET_HOST_NAME2.equals(url.getHost())
                                    || FASTCOIN_WALLET_HOST_NAME3.equals(url.getHost()) || FASTCOIN_WALLET_HOST_NAME4.equals(url.getHost()))) {
                        browser.visit(url.toString(), false);
                    } else {
                        StringBuilder text = new StringBuilder();
                        text.append("The help contents can only show HTTP content from ")
                            .append(FASTCOIN_WALLET_HOST_NAME)
                            .append(", ")
                            .append(FASTCOIN_WALLET_HOST_NAME2)
                            .append(" and ")
                            .append(FASTCOIN_WALLET_HOST_NAME4)
