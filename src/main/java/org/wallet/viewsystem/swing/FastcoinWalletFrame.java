...
/*
 * JFrame displaying Swing version of FastcoinWallet
 */
public class FastcoinWalletFrame extends JFrame implements ViewSystem, ApplicationListener, WalletBusyListener, CurrencyConverterListener {
    ...
    public void onReorganize(Wallet wallet) {
        log.info("FastcoinWallet has been reorganised.");
    ...
    public void handleOpenFile(ApplicationEvent event) {
        // TODO i18n required.
        JOptionPane.showMessageDialog(this, "Sorry, opening of files with double click is not yet implemented.  FastcoinWallet was "
                + event.getFilename());
    }
