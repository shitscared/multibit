 ...
 */
public class ChangePasswordSubmitAction extends FastcoinWalletSubmitAction implements WalletBusyListener {
     ...
     */
    public ChangePasswordSubmitAction(FastcoinController fastcoinController, ChangePasswordPanel changePasswordPanel,
            ImageIcon icon, JPasswordField currentPassword, JPasswordField newPassword, JPasswordField repeatNewPassword) {
        super(fastcoinController, "changePasswordSubmitAction.text", "changePasswordSubmitAction.tooltip", "changePasswordSubmitAction.mnemonicKey", icon);
            ...
            if (!perWalletModelData.isBusy()) {
                ...
                if (decryptSuccess) {
                    try {
                        ...
                        fileHandler.savePerWalletModelData(super.fastcoinController.getModel().getActivePerWalletModelData(), true);
