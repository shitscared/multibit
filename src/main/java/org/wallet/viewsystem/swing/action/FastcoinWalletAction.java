...
/**
 * This {@link Action} represents a localised FastcoinWallet action that just displays a view
 */
public class FastcoinWalletAction extends AbstractAction {
     ...
     */
    public FastcoinWalletAction(Controller controller, String imagePath, String textKey, String tooltipKey, String mnemonicKey, View viewToDisplay) {
