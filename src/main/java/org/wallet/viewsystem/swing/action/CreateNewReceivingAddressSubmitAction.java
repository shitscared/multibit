...
import org.wallet.model.fastcoin.*;
 ...
 * addresses.
 */
public class CreateNewReceivingAddressSubmitAction extends FastcoinWalletSubmitAction implements WalletBusyListener {
     ...
     */
    public CreateNewReceivingAddressSubmitAction(FastcoinController fastcoinController,
        ...
        super(fastcoinController, "createNewReceivingAddressSubmitAction.text", "createNewReceivingAddressSubmitAction.tooltip",
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (!perWalletModelData.isBusy()) {
            ...
            String walletDescription =  super.fastcoinController.getModel().getActiveWalletInfo().getProperty(WalletInfoData.DESCRIPTION_PROPERTY);
    ...
    private void createNewReceivingAddressesInBackground(final int numberOfAddressesToCreate, final boolean encryptNewKeys, 
        ...
        final FastcoinController finalController = super.fastcoinController;
            ...
            protected void done() {
                try {
                    ...
                    if (wasSuccessful) {
                        ...
                        if (createNewReceivingAddressPanel.getReceiveFastcoinPanel() != null) {
                            createNewReceivingAddressPanel.getReceiveFastcoinPanel().getAddressesTableModel().fireTableDataChanged();
                            createNewReceivingAddressPanel.getReceiveFastcoinPanel().selectRows();
                        }
                        
                        finalPerWalletModelData.getWalletInfo().put(FastcoinModel.RECEIVE_ADDRESS, lastAddressString);
                        finalPerWalletModelData.getWalletInfo().put(FastcoinModel.RECEIVE_LABEL, "");
    ...
    public void walletBusyChange(boolean newWalletIsBusy) {
        ...
        if (super.fastcoinController.getModel().getActivePerWalletModelData().isBusy()) {
            ...
            if (!super.fastcoinController.getModel().getActivePerWalletModelData().isFilesHaveBeenChangedByAnotherProcess()) {
                putValue(SHORT_DESCRIPTION, this.fastcoinController.getLocaliser().getString("createNewReceivingAddressSubmitAction.tooltip"));
                setEnabled(true);
            }
