...
public class CopyReceiveAddressAction extends AbstractAction {
     ...
     * @param copyIcon
     */
    public CopyReceiveAddressAction(Controller controller, ReceiveFastcoinPanel receiveFastcoinPanel, ImageIcon copyIcon) {
        super("", copyIcon);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        textTransfer.setClipboardContents(receiveFastcoinPanel.getReceiveAddress());
    }
}