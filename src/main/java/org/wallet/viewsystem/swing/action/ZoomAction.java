...
public class ZoomAction extends AbstractAction {
     ...
     */
    public ZoomAction(FastcoinController fastcoinController, ImageIcon icon, FastcoinWalletFrame mainFrame, AbstractTradePanel tradePanel) {
        super(fastcoinController.getLocaliser().getString("zoomAction.text"), icon);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            String address = this.fastcoinController.getModel().getActiveWalletPreference(tradePanel.getAddressConstant());
            String label = this.fastcoinController.getModel().getActiveWalletPreference(tradePanel.getLabelConstant());
            String amount = this.fastcoinController.getModel().getActiveWalletPreference(tradePanel.getAmountConstant());
            ...
            QRCodeGenerator qrCodeGenerator = new QRCodeGenerator(this.fastcoinController);
            ...
            String dialogTitle = controller.getLocaliser().getString("fastcoinWalletFrame.title") + FastcoinWalletFrame.SEPARATOR
