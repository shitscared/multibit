...
/**
 * This {@link Action} enables you to paste a swatch into the Send Fastcoin Panel
 */
public class PasteSwatchAction extends AbstractAction {
     ...
     */
    public PasteSwatchAction(FastcoinController fastcoinController, AbstractTradePanel tradePanel, Icon icon) {
        super("", icon);
