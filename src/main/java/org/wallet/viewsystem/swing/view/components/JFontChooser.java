 ...
 * release under MIT license - same as FastcoinWallet
 ************************************************************/
...
public class JFontChooser extends JComponent {
    ...
    private FastcoinWalletTextField fontFamilyTextField = null;
    private FastcoinWalletTextField fontStyleTextField = null;
    private FastcoinWalletTextField fontSizeTextField = null;
    ...
    public JFontChooser(Controller controller) {
        ...
        int minimumWidth = fontMetrics.stringWidth(FastcoinWalletFrame.EXAMPLE_LONG_FIELD_TEXT) + WIDTH_DELTA;
    ...
    public JTextField getFontFamilyTextField() {
        if (fontFamilyTextField == null) {
            fontFamilyTextField = new FastcoinWalletTextField("", 40, controller, 12);
    ...
    public JTextField getFontStyleTextField() {
        if (fontStyleTextField == null) {
            fontStyleTextField = new FastcoinWalletTextField("", 40, controller, 12);
    ...
    public JTextField getFontSizeTextField() {
        if (fontSizeTextField == null) {
            fontSizeTextField = new FastcoinWalletTextField("", 40, controller, 12);
    ...
    protected JDialog createDialog(Component parent) {
        ...
        FastcoinWalletButton cancelButton = new FastcoinWalletButton(cancelAction, controller);
    ...
    protected JPanel getFontFamilyPanel() {
        if (fontNamePanel == null) {
            ...
            FastcoinWalletLabel label = new FastcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontName"));
    ...
    protected JPanel getFontStylePanel() {
        if (fontStylePanel == null) {
            ...
            FastcoinWalletLabel label = new FastcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontStyle"));
            label.applyComponentOrientation(ComponentOrientation.getOrientation(controller.getLocaliser().getLocale()));
            label.setHorizontalAlignment(JLabel.LEADING);
            label.setHorizontalTextPosition(JLabel.LEADING);
    ...
    protected JPanel getFontSizePanel() {
        if (fontSizePanel == null) {
            ...
            FastcoinWalletLabel label = new FastcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontSize"));
            label.applyComponentOrientation(ComponentOrientation.getOrientation(controller.getLocaliser().getLocale()));
