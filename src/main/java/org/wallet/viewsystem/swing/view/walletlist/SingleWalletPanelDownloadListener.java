...
public class SingleWalletPanelDownloadListener extends DownloadListener {
    ...
    public SingleWalletPanelDownloadListener(FastcoinController fastcoinController, SingleWalletPanel singleWalletPanel) {
    ...
    public void progress(double pct, int blocksSoFar, Date date) {
        if (pct > DONE_FOR_DOUBLES) {
            ...
            synchronized (lockObject) {
                String downloadStatusText = controller.getLocaliser().getString("fastcoinWalletDownloadListener.downloadingTextShort");
    ...
    public void startDownload(int blocks) {
        if (blocks == 0) {
            ...
            synchronized (lockObject) {
                String startDownloadText = controller.getLocaliser().getString("fastcoinWalletDownloadListener.downloadingTextShort");
