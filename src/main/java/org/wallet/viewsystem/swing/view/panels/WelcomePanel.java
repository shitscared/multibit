...
import org.wallet.viewsystem.swing.view.components.FastcoinWalletTextArea;
...
public class WelcomePanel extends JPanel implements Viewable {
     ...
     */
    public WelcomePanel(Controller controller, FastcoinWalletFrame mainFrame) {
    ...
    private JPanel createWelcomePanel() {
        FastcoinWalletTitledPanel welcomePanel = new FastcoinWalletTitledPanel(controller.getLocaliser().getString("welcomePanel.title"), ComponentOrientation.getOrientation(controller.getLocaliser().getLocale()));
        ...
        FastcoinWalletTitledPanel.addLeftJustifiedTextAtIndent(" ", 3, welcomePanel);

        String paragraph1 = controller.getLocaliser().getString("welcomePanel.paragraph1");
        int height1 = calculateHeight(paragraph1);

        FastcoinWalletTextArea paragraph1TextArea = new FastcoinWalletTextArea(paragraph1, height1, TEXT_WIDTH, controller);
        ...
        FastcoinWalletTextArea paragraph2TextArea = new FastcoinWalletTextArea(paragraph2, height2, TEXT_WIDTH, controller);
        ...
        FastcoinWalletTextArea paragraph25TextArea = new FastcoinWalletTextArea(paragraph25, height25, TEXT_WIDTH, controller);
        ...
        FastcoinWalletTextArea paragraph3TextArea = new FastcoinWalletTextArea(paragraph3, height3, TEXT_WIDTH, controller);
        ...
        FastcoinWalletTextArea paragraph4TextArea = new FastcoinWalletTextArea(paragraph4, height4, TEXT_WIDTH, controller);
