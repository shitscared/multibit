 ...
 * 
 */
public class FastcoinWalletTitledPanel extends JPanel {
    ...
    public FastcoinWalletTitledPanel(String title, ComponentOrientation componentOrientation) {
        ...
        Font titleFont = FontSizer.INSTANCE.getAdjustedDefaultFontWithDelta(ColorAndFontConstants.FASTCOIN_WALLET_LARGE_FONT_INCREASE);
        ...
        titlePanel.add(FastcoinWalletTitledPanel.getIndentPanel(preferredHeight), constraints);
        ...
        constraints.weighty = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        FastcoinWalletLabel titleLabel = new FastcoinWalletLabel(title, JLabel.LEFT);
    ...
    public static FastcoinWalletLabel addLeftJustifiedTextAtIndent(String text, int row, JPanel panel) {
        GridBagConstraints constraints = new GridBagConstraints();
        constraints.fill = GridBagConstraints.BOTH;
        constraints.gridx = 0;
        ...
        FastcoinWalletLabel label = new FastcoinWalletLabel(text);
