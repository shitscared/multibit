...
import org.wallet.viewsystem.swing.browser.Browser;
...
public class HelpContentsPanel extends JPanel implements Viewable {
    ...
    // Version 0.4.x - live
    //public static final String HELP_BASE_URL = "http://www.wallet.org/";
    
    // Version 0.5.x - live
    public static final String HELP_BASE_URL = "http://www.wallet.org/v0.5/";
    
    
    // Version 0.4.x - test
    //public static final String HELP_BASE_URL = "http://test.wallet.org/";
    ...
    public static final String HELP_RECEIVING_URL = "help_receivingFastcoin.html";
    public static final String HELP_RESET_BLOCKCHAIN_URL = "help_resetBlockchain.html";
    public static final String HELP_SENDING_URL = "help_sendingFastcoin.html";
    ...
    public HelpContentsPanel(Controller controller, FastcoinWalletFrame mainFrame) {
        ...
        final FastcoinWalletFrame finalMainFrame = mainFrame;
    ...
    public static String createTooltipTextForMenuItem(String tooltip) {
        ...
        // Get property apple.laf.useScreenMenuBar - this is set in src/app-resources/FastcoinWallet.app/info.plist
        String useScreenMenuBar = System.getProperty("apple.laf.useScreenMenuBar");
        String lookAndFeel = "" + FastcoinWallet.getController().getModel().getUserPreference(CoreModel.LOOK_AND_FEEL);
    ...
    public static String createMultilineTooltipText(String[] toolTips) {
        ...
        FontSizer.INSTANCE.initialise(FastcoinWallet.getController());
