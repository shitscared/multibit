...
import org.wallet.viewsystem.swing.action.ShowOpenUriCancelAction;
import org.wallet.viewsystem.swing.action.ShowOpenUriSubmitAction;
 ...
 */
public class ShowOpenUriDialog extends FastcoinWalletDialog implements Viewable, ShowUriDialogDataProvider {
     ...
     */
    public ShowOpenUriDialog(FastcoinController fastcoinController, FastcoinWalletFrame mainFrame) {
        super(mainFrame, fastcoinController.getLocaliser().getString("showOpenUriView.title"));
    ...
    private void initUI() {
        ...
        ShowOpenUriSubmitAction showOpenUriSubmitAction = new ShowOpenUriSubmitAction(mainFrame, this.fastcoinController, this, this);
    ...
    // FastcoinFormDataProvider methods
    @Override
    public String getAddress() {
        return controller.getModel().getUserPreference(FastcoinModel.OPEN_URI_ADDRESS);
    }

    @Override
    public String getLabel() {
        return controller.getModel().getUserPreference(FastcoinModel.OPEN_URI_LABEL);
    }

    @Override
    public String getAmount() {
        return controller.getModel().getUserPreference(FastcoinModel.OPEN_URI_AMOUNT);
    }
