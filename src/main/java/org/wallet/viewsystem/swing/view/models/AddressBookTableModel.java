...
public class AddressBookTableModel extends DefaultTableModel {
    ...
    public AddressBookTableModel(FastcoinController fastcoinController, boolean isReceiving) {
    ...
    public int getRowCount() {
        ...
        WalletInfoData walletInfo = this.fastcoinController.getModel().getActiveWalletInfo();
        if (isReceiving) {
