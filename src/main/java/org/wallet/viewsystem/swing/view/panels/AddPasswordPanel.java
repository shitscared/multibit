...
import org.wallet.viewsystem.swing.action.AddPasswordSubmitAction;
...
public class AddPasswordPanel extends JPanel implements Viewable, WalletBusyListener {
     ...
     */
    public AddPasswordPanel(FastcoinController fastcoinController, FastcoinWalletFrame mainFrame) {
    ...
    private JPanel createPasswordPanel(int stentWidth) {
        ...
        reminderLabel1 = new FastcoinWalletLabel(controller.getLocaliser().getString("addPasswordPanel.reminder1"));
        ...
        reminderLabel2 = new FastcoinWalletLabel(controller.getLocaliser().getString("addPasswordPanel.reminder2"));
        ...
        reminderLabel3 = new FastcoinWalletLabel(controller.getLocaliser().getString("addPasswordPanel.reminder3"));
    ...
    private JPanel createButtonPanel() {
         ...
         */
        addPasswordSubmitAction = new AddPasswordSubmitAction(this.fastcoinController, this,
                ImageLoader.createImageIcon(ImageLoader.ADD_PASSWORD_ICON_FILE), passwordField, repeatPasswordField);
        FastcoinWalletButton submitButton = new FastcoinWalletButton(addPasswordSubmitAction, controller);
    ...
    public final void walletBusyChange(boolean newWalletIsBusy) {
        if (this.fastcoinController.getModel().getActiveWallet() != null) {
            if (this.fastcoinController.getModel().getActiveWallet().getEncryptionType() != EncryptionType.UNENCRYPTED) {
