...
import org.wallet.viewsystem.dataproviders.PreferencesDataProvider;
import org.wallet.viewsystem.swing.ColorAndFontConstants;
import org.wallet.viewsystem.swing.FastcoinWalletFrame;
import org.wallet.viewsystem.swing.action.ChooseFontAction;
import org.wallet.viewsystem.swing.action.HelpContextAction;
import org.wallet.viewsystem.swing.action.ShowPreferencesSubmitAction;
import org.wallet.viewsystem.swing.action.UndoPreferencesChangesSubmitAction;
import org.wallet.viewsystem.swing.view.components.*;
import org.wallet.viewsystem.swing.view.ticker.TickerTableModel;
...
public class ShowPreferencesPanel extends JPanel implements Viewable, PreferencesDataProvider {
    ...
    private FastcoinWalletLabel fontNameTextLabel;
    private FastcoinWalletLabel fontStyleTextLabel;
    private FastcoinWalletLabel fontSizeTextLabel;

    private FastcoinWalletLabel exchangeInformationLabel;

    private String originalFontName;
    private String originalFontStyle;
    private String originalFontSize;

    private FastcoinWalletButton undoChangesButton;

    private String originalUserLanguageCode;

    private boolean originalShowTicker;
    private boolean originalShowFastcoinConvertedToFiat;
    ...
    private JCheckBox showFastcoinConvertedToFiat;
    ...
    private FastcoinWalletLabel exchangeLabel2;
    private FastcoinWalletLabel currencyLabel2;
    ...
    private FastcoinWalletTextField oerApiCodeTextField;
    private String haveShownErrorMessageForApiCode;
    private FastcoinWalletButton getOerAppIdButton;
    private FastcoinWalletLabel oerApiCodeLabel;
    private FastcoinWalletLabel oerMessageLabel1, oerMessageLabel2;
    private String originalOERApiCode;
    public static final String OPEN_EXCHANGE_RATES_SIGN_UP_URI = "https://openexchangerates.org/signup/free?r=wallet";
     ...
     */
    public ShowPreferencesPanel(FastcoinController fastcoinController, ExchangeController exchangeController, FastcoinWalletFrame mainFrame) {
    ...
    public void displayView(DisplayHint displayHint) {
        ...
        originalShowFastcoinConvertedToFiat = !Boolean.FALSE.toString().equals(
                controller.getModel().getUserPreference(ExchangeModel.SHOW_FASTCOIN_CONVERTED_TO_FIAT));
        showFastcoinConvertedToFiat.setSelected(originalShowFastcoinConvertedToFiat);

        String showDialogString = controller.getModel().getUserPreference(FastcoinModel.OPEN_URI_SHOW_DIALOG);
        String useUriString = controller.getModel().getUserPreference(FastcoinModel.OPEN_URI_USE_URI);
        ...
        if (fontNameString == null || "".equals(fontNameString)) {
            fontNameString = ColorAndFontConstants.FASTCOIN_WALLET_DEFAULT_FONT_NAME;
        }
        originalFontName = fontNameString;

        int fontStyle = ColorAndFontConstants.FASTCOIN_WALLET_DEFAULT_FONT_STYLE;
        ...
        int fontSize = ColorAndFontConstants.FASTCOIN_WALLET_DEFAULT_FONT_SIZE;
    ...
    private JPanel createLanguagePanel(int stentWidth) {
        // Language radios.
        FastcoinWalletTitledPanel languagePanel = new FastcoinWalletTitledPanel(controller.getLocaliser().getString(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        JPanel stent = FastcoinWalletTitledPanel.createStent(stentWidth);
        ...
        languagePanel.add(FastcoinWalletTitledPanel.createStent(FastcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);
    ...
    private JPanel createAppearancePanel(int stentWidth) {
        FastcoinWalletTitledPanel appearancePanel = new FastcoinWalletTitledPanel(controller.getLocaliser().getString(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        appearancePanel.add(FastcoinWalletTitledPanel.createStent(FastcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);

        FastcoinWalletLabel fontNameLabel = new FastcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontName"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 4;
        constraints.weightx = 0.3;
        ...
        fontNameTextLabel = new FastcoinWalletLabel("");
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 3;
        constraints.gridy = 4;
        constraints.weightx = 0.3;
        ...
        FastcoinWalletLabel fontStyleLabel = new FastcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontStyle"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 5;
        constraints.weightx = 0.3;
        ...
        fontStyleTextLabel = new FastcoinWalletLabel("");
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 3;
        constraints.gridy = 5;
        constraints.weightx = 0.3;
        ...
        FastcoinWalletLabel fontSizeLabel = new FastcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontSize"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 6;
        constraints.weightx = 0.3;
        ...
        fontSizeTextLabel = new FastcoinWalletLabel("");
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 3;
        constraints.gridy = 6;
        constraints.weightx = 0.3;
        ...
        FastcoinWalletButton fontChooserButton = new FastcoinWalletButton(chooseFontAction, controller);
        ...
        constraints.gridwidth = 3;
        constraints.anchor = GridBagConstraints.LINE_START;
        appearancePanel.add(FastcoinWalletTitledPanel.createStent(1, 30), constraints);

        FastcoinWalletLabel lookAndFeelLabel = new FastcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.lookAndFeel"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 9;
        constraints.weightx = 0.3;
        ...
        if (lookAndFeels != null) {
            lookAndFeelComboBox.addItem("WebLookAndFeel");
            lookAndFeelComboBox.setSelectedItem("WebLookAndFeel");
    ...
    private JPanel createTickerPanel(int stentWidth) {
        ...
        FastcoinWalletTitledPanel tickerPanel = new FastcoinWalletTitledPanel(controller.getLocaliser().getString(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        tickerPanel.add(FastcoinWalletTitledPanel.createStent(FastcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);

        String showTickerText = controller.getLocaliser().getString("fastcoinWalletFrame.ticker.show.text");
        ...
        exchangeInformationLabel = new FastcoinWalletLabel(controller.getLocaliser().getString(
                "showPreferencesPanel.ticker.exchangeInformation"));
        exchangeInformationLabel.setVisible(originalShowFastcoinConvertedToFiat);

        showFastcoinConvertedToFiat = new JCheckBox(controller.getLocaliser().getString(
                "showPreferencesPanel.ticker.showFastcoinConvertedToFiat"));
        showFastcoinConvertedToFiat.setOpaque(false);
        showFastcoinConvertedToFiat.setFont(FontSizer.INSTANCE.getAdjustedDefaultFont());
        showFastcoinConvertedToFiat.setSelected(originalShowFastcoinConvertedToFiat);

        showFastcoinConvertedToFiat.addItemListener(new ItemListener() {
            @Override
        ...
        constraints.gridwidth = 4;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(showFastcoinConvertedToFiat, constraints);
        ...
        constraints.gridwidth = 3;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(FastcoinWalletTitledPanel.createStent(1, 12), constraints);
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(FastcoinWalletTitledPanel.createStent(1, 13), constraints);

        FastcoinWalletTitledPanel.addLeftJustifiedTextAtIndent(controller.getLocaliser()
                .getString("showPreferencesPanel.ticker.firstRow"), 14, tickerPanel);

        FastcoinWalletLabel exchangeLabel1 = new FastcoinWalletLabel(controller.getLocaliser()
        ...
        oerMessageLabel1 = new FastcoinWalletLabel("    " + controller.getLocaliser().getString("showPreferencesPanel.getAppId.label"));
        ...
        FastcoinWalletLabel currencyLabel1 = new FastcoinWalletLabel(controller.getLocaliser()
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(FastcoinWalletTitledPanel.createStent(12, 12), constraints);
        ...
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(
                FastcoinWalletTitledPanel.createStent(fontMetrics.stringWidth(exchangeInformationLabel.getText()),
        ...
        exchangeLabel2 = new FastcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.ticker.exchange"));
        ...
        oerMessageLabel2 = new FastcoinWalletLabel("    " + controller.getLocaliser().getString("showPreferencesPanel.getAppId.label"));
        ...
        currencyLabel2 = new FastcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.ticker.currency"));
        ...
        oerStent = FastcoinWalletTitledPanel.createStent(12, 12);
        constraints.fill = GridBagConstraints.BOTH;
        constraints.gridx = 1;
        ...
        oerApiCodeLabel = new FastcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.oerLabel.text"));
        ...
        oerApiCodeTextField = new FastcoinWalletTextField("", 25, controller);
        ...
        if (isBrowserSupported()) {
            getOerAppIdButton = new FastcoinWalletButton(controller.getLocaliser().getString("showPreferencesPanel.getAppId.text"));
    ...
    private JPanel createBrowserIntegrationPanel(int stentWidth) {
        FastcoinWalletTitledPanel browserIntegrationPanel = new FastcoinWalletTitledPanel(controller.getLocaliser().getString(
    ...
    private JPanel createButtonPanel() {
        ...
        helpButton.setText("");
        helpButton.setToolTipText(controller.getLocaliser().getString("fastcoinWalletFrame.helpMenuTooltip"));
        ...
        ShowPreferencesSubmitAction submitAction = new ShowPreferencesSubmitAction(this.fastcoinController, this.exchangeController, this,
                ImageLoader.createImageIcon(ImageLoader.PREFERENCES_ICON_FILE), mainFrame);
        FastcoinWalletButton submitButton = new FastcoinWalletButton(submitAction, controller);
        ...
        undoChangesButton = new FastcoinWalletButton(undoChangesAction, controller);
    ...
    class LanguageComboBoxRenderer extends FastcoinWalletLabel implements ListCellRenderer {
    ...
    @Override
    public boolean getPreviousShowFastcoinConvertedToFiat() {
        return originalShowFastcoinConvertedToFiat;
    }

    @Override
    public boolean getNewShowFastcoinConvertedToFiat() {
        return showFastcoinConvertedToFiat.isSelected();
    }
