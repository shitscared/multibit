...
public class ApplicationDataDirectoryLocator {
     ...
     * 
     * 1. See if there is a wallet.properties in FastcoinWallet's current working
     ...
     * 
     * PC System.getenv("APPDATA")/FastcoinWalletInExecutableJar
     * 
     * e.g. C:/Documents and Settings/Administrator/Application Data/FastcoinWalletInExecutableJar
     * 
     * Mac System.getProperty("user.home")/Library/Application Support/FastcoinWalletInExecutableJar
     * 
     * e.g. /Users/jim/Library/Application Support/FastcoinWalletInExecutableJar
     * 
     * Linux System.getProperty("user.home")/FastcoinWalletInExecutableJar
     * 
     * e.g. /Users/jim/FastcoinWalletInExecutableJar
     */
    public String getApplicationDataDirectory() {
        ...
        File fastcoinwalletPropertiesFile = new File(FileHandler.USER_PROPERTIES_FILE_NAME);
        if (fastcoinwalletPropertiesFile.exists()) {
            ...
            if (operatingSystemName != null && operatingSystemName.startsWith("Windows")) {
                // Windows os
                applicationDataDirectory = System.getenv("APPDATA") + File.separator + "FastcoinWallet";
            } else {
                if (operatingSystemName != null && operatingSystemName.startsWith("Mac")) {
                    ...
                    if ( (new File("../../../../" + FileHandler.USER_PROPERTIES_FILE_NAME)).exists()) {
                        ...
                        applicationDataDirectory = System.getProperty("user.home") + "/Library/Application Support/FastcoinWallet";
                    }
                } else {
                    // treat as Linux/ unix variant
                    applicationDataDirectory = System.getProperty("user.home") + "/FastcoinWallet";
                }
            }
     ...
     * This is the directory into which FastcoinWallet was installed.
     * @throws IOException 
     * 
