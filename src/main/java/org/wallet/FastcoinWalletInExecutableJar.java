...
/**
 * Main FastcoinWalletInExecutableJar entry class for when running in an executable jar - put console
 * output to a file
 */
public final class FastcoinWalletInExecutableJar {

    public static final String OUTPUT_DIRECTORY = "log";
    public static final String CONSOLE_OUTPUT_FILENAME = "wallet.log";

    private static Logger log = LoggerFactory.getLogger(FastcoinWalletInExecutableJar.class);

    /**
     * Utility class should not have a public constructor
     */
    private FastcoinWalletInExecutableJar() {
    }
     ...
     * @param args The optional command line arguments ([0] can be a Fastcoin URI
     */
    public static void main(String args[]) {
        ...
        try {
            ...
            log = LoggerFactory.getLogger(FastcoinWalletInExecutableJar.class);
            ...
            // call the main FastcoinWalletInExecutableJar code
            FastcoinWallet.main(args);
        }
    }
}
