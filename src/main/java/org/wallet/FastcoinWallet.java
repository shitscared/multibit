...
/**
 * Main FastcoinWallet entry class.
 *
 * @author jim
 */
public final class FastcoinWallet {

    private static final Logger log = LoggerFactory.getLogger(FastcoinWallet.class);
     ...
     */
    private FastcoinWallet() {
    }
    static WalletAppKit appKit = null;
    /**
     * Start FastcoinWallet user interface.
     *
    ...
    public static void main(final String args[]) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                log.info("Starting FastcoinWallet at " + (new Date()).toGMTString());
                ...
                try {
                    ...
                    log.info("Checking to see if this is the primary FastcoinWallet instance");
                    String rawURI = null;
                    if (args != null && args.length > 0) {
                        rawURI = args[0];
                        log.debug("The args[0] passed into FastcoinWallet = '" + args[0] + "'");
                    }
                    if (!ApplicationInstanceManager.registerInstance(rawURI)) {
                        // Instance already running.
                        log.debug("Another instance of FastcoinWallet is already running.  Exiting.");
                        System.exit(0);
                    }
                    ...
                    ApplicationInstanceManager.setApplicationInstanceListener(new ApplicationInstanceListener() {
                        ...
                        public void newInstanceCreated(String rawURI) {
                            ...
                            log.debug("New instance of FastcoinWallet detected, rawURI = " + rawURI + " ...");
                    ...
                    log.debug("FastcoinWallet version = " + localiser.getVersionNumber());
                    ...
                    if (numberOfEarlyWalletsAsString == null || "".equals(numberOfEarlyWalletsAsString) || "null".equals(numberOfEarlyWalletsAsString)) {
                        ...
                        try {
                            ...
                            // If there is no active filename this is a new instance of FastcoinWallet so backup the new wallet when created.
                            ...
                            if (wallet != null) {
                                ...
                                if (lastBlockSeenHeight > 0 && currentChainHeight > 0) {
                                    if (lastBlockSeenHeight >= currentChainHeight) {
                                        // FastcoinWallet is at or ahead of current chain - no
                    ...
                    log.error("An unexpected error caused FastcoinWallet to quit.");
    ...
    public static void setCoreController(CoreController coreController) {
        FastcoinWallet.controller = coreController;
        FastcoinWallet.coreController = coreController;
    }

    public static void setFastcoinController(FastcoinController fastcoinController) {
        FastcoinWallet.fastcoinController = fastcoinController;
    }

    public static void setExchangeController(ExchangeController exchangeController) {
        FastcoinWallet.exchangeController = exchangeController;
    }
    ...
    public static void setRememberedRawFastcoinURI(String rememberedRawFastcoinURI) {
        ...
        FastcoinWallet.rememberedRawFastcoinURI = rememberedRawFastcoinURI;
    }
}
