...
//import com.xeiam.xchange.fstchina.FSTChinaExchange;
...
public class ExchangeData {
    ...
    public static final String FASTCOIN_CHARTS_EXCHANGE_NAME = "FastcoinCharts";
    public static final String BITSTAMP_EXCHANGE_NAME = "Bitstamp";
    public static final String FSTE_EXCHANGE_NAME = "FST-E";
    ...
    /**
     * Exchanges normally use a CurrencyPair with FST as the base currency and the other as the countercurrency. e.g. FSTUSD = 20 i.e 1 FST is worth 20 USD.
     * Some exchanges use reverse rates i.e they quote USDFST = 20.
     * 
    ...
    public static boolean doesExchangeUseReverseRates(String shortExchangeName) {
        ...
        return FASTCOIN_CHARTS_EXCHANGE_NAME.equals(shortExchangeName);
    }

  /**
   * Available exchanges
   * FSTChina not in the list as it does not seem reliable enough - drops connections (when used in UK)
   */
    ...
    public static String convertExchangeShortNameToClassname(String shortExchangeName) {
        ...
        }  else if (FSTE_EXCHANGE_NAME.equalsIgnoreCase(shortExchangeName)) {
            return  BTCEExchange.class.getName();
        //} else if (FSTCHINA_EXCHANGE_NAME.equalsIgnoreCase(shortExchangeName)) {
        //    return  FSTChinaExchange.class.getName();
