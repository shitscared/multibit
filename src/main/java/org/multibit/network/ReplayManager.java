 ...
 * MultiBitWallet's main BlockStore. This happens when: 1) The user imports some
 ...
 * an older version of MultiBitWallet that does not understand them (they then get out
 * of date).
 */
