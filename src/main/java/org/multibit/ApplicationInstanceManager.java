...
public final class ApplicationInstanceManager {
    ...
    /**
     * MultiBitWallet port number, as specified in
     * http://en.wikipedia.org/wiki/List_of_TCP_and_UDP_port_numbers
     */
    public static final int FASTCOIN_WALLET_NETWORK_SOCKET = 11043;

    /**
     * Multibit message start - must end with newline
     */
    public static final String MESSAGE_START = "$$FastcoinWalletMessageStart$$\n";
    ...
    public static boolean registerInstance(String rawURI) {
        ...
        // return false
        try {
            final ServerSocket socket = new ServerSocket(FASTCOIN_WALLET_NETWORK_SOCKET, 10, InetAddress.getByAddress(new byte[]{127, 0,
                0, 1}));
            log.debug("Listening for application instances on socket " + FASTCOIN_WALLET_NETWORK_SOCKET);
            ...
            try {
                Socket clientSocket = new Socket(InetAddress.getByAddress(new byte[]{127, 0, 0, 1}), FASTCOIN_WALLET_NETWORK_SOCKET);
