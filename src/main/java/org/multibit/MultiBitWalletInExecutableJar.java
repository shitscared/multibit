...
/**
 * Main MultiBitWalletInExecutableJar entry class for when running in an executable jar - put console
 * output to a file
 */
public final class MultiBitWalletInExecutableJar {

    public static final String OUTPUT_DIRECTORY = "log";
    public static final String CONSOLE_OUTPUT_FILENAME = "wallet.log";

    private static Logger log = LoggerFactory.getLogger(MultiBitWalletInExecutableJar.class);

    /**
     * Utility class should not have a public constructor
     */
    private MultiBitWalletInExecutableJar() {
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            log = LoggerFactory.getLogger(MultiBitWalletInExecutableJar.class);
            ...
            // call the main MultiBitWalletInExecutableJar code
            MultiBitWallet.main(args);
        }
    }
}
