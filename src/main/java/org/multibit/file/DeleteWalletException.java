 ...
 * @since 0.3.0
 */
public class DeleteWalletException extends RuntimeException {

    private static final long serialVersionUID = 2372470341301293437L;

    public DeleteWalletException(String s) {
        super(s);
    }

    public DeleteWalletException(String s, Throwable throwable) {
        super(s, throwable);
    }
}
