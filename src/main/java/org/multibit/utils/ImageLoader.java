...
public final class ImageLoader {
    ...
    public static final String FASTCOIN_WALLET_128_ICON_FILE = "/images/fastcoin128.png";
    public static final String FASTCOIN_WALLET_ICON_FILE = "/images/fastcoin.png";
    public static final String FASTCOIN_WALLET_SMALL_ICON_FILE = "/images/fastcoin-small.png";
    ...
    public static final String RECEIVE_FASTCOIN_ICON_FILE = "/images/receiveIn.png";
    ...
    public static final String SEND_FASTCOIN_ICON_FILE = "/images/sendOut.png";
    ...
    public static ImageIcon createImageIcon(String path) {
        ...
        java.net.URL imgURL = FastcoinWalletFrame.class.getResource(path);
        if (imgURL != null) {
            return new ImageIcon(imgURL);
        } else {
            log.error("org.multibit.FastcoinWalletFrame#createImageIcon: Could not find file: " + path);
            return null;
        }
    }
}
