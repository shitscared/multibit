...
/**
 * An interface describing a collection of views that are used to render the MultiBitWallet application.
 * @author jim
 *
 */
public interface ViewSystem extends WalletEventListener { 
    ...
    /**
     * A method called when MultiBitWallet online status changes between online, connecting. error.
     */
