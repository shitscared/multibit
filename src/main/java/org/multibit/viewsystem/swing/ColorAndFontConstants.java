...
public final class ColorAndFontConstants {
  ...
  public static String FASTCOIN_WALLET_DEFAULT_FONT_NAME;
  public static int FASTCOIN_WALLET_DEFAULT_FONT_STYLE;
  public static int FASTCOIN_WALLET_DEFAULT_FONT_SIZE;
  public static int FASTCOIN_WALLET_LARGE_FONT_INCREASE = 1;
  ...
  public static void init() {
    FASTCOIN_WALLET_DEFAULT_FONT_NAME = UIManager.get("Label.font") == null ? Font.DIALOG : ((Font) UIManager.get("Label.font"))
            .getFontName();
    FASTCOIN_WALLET_DEFAULT_FONT_STYLE = UIManager.get("Label.font") == null ? 0 : ((Font) UIManager.get("Label.font")).getStyle();
    FASTCOIN_WALLET_DEFAULT_FONT_SIZE = UIManager.get("Label.font") == null ? 13 : ((Font) UIManager.get("Label.font")).getSize() + 1;
