...
public class ShowTransactionDetailsAction extends AbstractAction {
     ...
     */
    public ShowTransactionDetailsAction(FastcoinController fastcoinController, FastcoinWalletFrame mainFrame, ShowTransactionsPanel showTransactionsPanel) {
        super(fastcoinController.getLocaliser().getString("showTransactionsDetailAction.text"), ImageLoader.createImageIcon(ImageLoader.TRANSACTIONS_ICON_FILE));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        final TransactionDetailsDialog transactionDetailsDialog = new TransactionDetailsDialog(this.fastcoinController, mainFrame, rowTableData);
