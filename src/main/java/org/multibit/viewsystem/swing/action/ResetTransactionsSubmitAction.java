 ...
 */
public class ResetTransactionsSubmitAction extends FastcoinWalletSubmitAction {
     ...
     */
    public ResetTransactionsSubmitAction(FastcoinController fastcoinController, FastcoinWalletFrame mainFrame, Icon icon) {
        super(fastcoinController, "resetTransactionsSubmitAction.text", "resetTransactionsSubmitAction.tooltip",
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        WalletData activePerWalletModelData = super.fastcoinController.getModel().getActivePerWalletModelData();
        ...
        try {
            super.fastcoinController.getFileHandler().savePerWalletModelData(activePerWalletModelData, true);

            super.fastcoinController.getModel().createWalletTableData(super.fastcoinController, super.fastcoinController.getModel().getActiveWalletFilename());
    ...
    private void resetTransactionsInBackground(final Date resetDate, final String walletFilename) {
        SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
            ...
            protected Boolean doInBackground() throws Exception {
                ...
                perWalletModelDataList.add(fastcoinController.getModel().getActivePerWalletModelData());
