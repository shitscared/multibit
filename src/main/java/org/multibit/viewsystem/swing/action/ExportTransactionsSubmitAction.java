...
public class ExportTransactionsSubmitAction extends AbstractAction {
     ...
     */
    public ExportTransactionsSubmitAction(FastcoinController fastcoinController, FastcoinWalletFrame mainFrame) {
        super(fastcoinController.getLocaliser().getString("exportTransactionsSubmitAction.text"), ImageLoader.createImageIcon(ImageLoader.TRANSACTIONS_EXPORT_ICON_FILE));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            String walletFilename = fastcoinController.getModel().getActiveWalletFilename();
            ...
            if (walletFilename != null) {
                ...
                defaultFileName = stem + "." + FastcoinModel.CSV_FILE_EXTENSION;
            } else {
                defaultFileName = fileChooser.getCurrentDirectory().getAbsoluteFile() + File.separator
                + controller.getLocaliser().getString("saveWalletAsView.untitled") + "." + FastcoinModel.CSV_FILE_EXTENSION;
            }
    ...
    void exportTransactions(String exportTransactionsFilename) {
        ...
        if (!exportTransactionsFilename.contains(".")) {
             exportTransactionsFilename = exportTransactionsFilename + "." + FastcoinModel.CSV_FILE_EXTENSION;
        }
        ...
        exportTransactionsDoIt(fastcoinController.getModel().getActivePerWalletModelData(), exportTransactionsFilename);
    }
    ...
    public void exportTransactionsDoIt(WalletData walletData, String exportTransactionsFilename) {        
        List<WalletTableData> walletTableDataList = fastcoinController.getModel().createWalletTableData(fastcoinController, walletData);
        ...
        try {
            ...
            headerConverter.setFastcoinController(fastcoinController);
            ...
            converter.setFastcoinController(fastcoinController);
