...
public class CopySendAddressAction extends AbstractAction {
     ...
     */
    public CopySendAddressAction(Controller controller, SendFastcoinPanel sendFastcoinPanel, ImageIcon icon) {
        super("", icon);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        textTransfer.setClipboardContents(sendFastcoinPanel.getAddress());
    }
}