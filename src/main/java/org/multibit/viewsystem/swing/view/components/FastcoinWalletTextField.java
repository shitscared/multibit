...
public class FastcoinWalletTextField extends JTextField {
    ...
    public FastcoinWalletTextField(String text, int width, Controller controller) {
        this(text, width, controller, HEIGHT_DELTA);
    }

    public FastcoinWalletTextField(String text, int width, Controller controller, int heightDelta) {
        super(text, width);
