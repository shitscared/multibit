...
public class FastcoinWalletFormattedTextField extends JFormattedTextField {
    ...
    public FastcoinWalletFormattedTextField(String text, int width, Controller controller, DecimalFormat format) {
        super(format);
