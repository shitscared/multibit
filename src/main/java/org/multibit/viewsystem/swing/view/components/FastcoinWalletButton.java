...
/**
 * button used in MultiBitWallet Swing UI
 * @author jim
 *
 */
public class FastcoinWalletButton extends JButton {

    private static final long serialVersionUID = 5632457290711815650L;
    
    public FastcoinWalletButton(Action action, Controller controller) {
        super(action);
    ...
    public FastcoinWalletButton(String label) {
        super(label);
