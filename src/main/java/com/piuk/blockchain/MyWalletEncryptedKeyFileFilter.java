...
public class MyWalletEncryptedKeyFileFilter extends javax.swing.filechooser.FileFilter {
    ...
    public boolean accept(File file) {
        return (file.getName().toLowerCase().endsWith(FastcoinModel.BLOCKCHAIN_WALLET_ENCRYPTED_SUFFIX));
    }
    ...
    public String getDescription() {
        ...
        fastcoinWalletText += "Blockchain.info " + " (*." + FastcoinModel.BLOCKCHAIN_WALLET_ENCRYPTED_SUFFIX + ")";
